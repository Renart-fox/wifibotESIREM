...
public:
    ...
    {
        changeIP->setWindowTitle(QApplication::translate("changeIP", "Dialog", 0));
        label->setText(QApplication::translate("changeIP", "Please input the IPv4 address of your WiFi Bot", 0));
        case1->setPlainText(QApplication::translate("changeIP", "192", 0));
        case2->setPlainText(QApplication::translate("changeIP", "168", 0));
        case3->setPlainText(QApplication::translate("changeIP", "1", 0));
        case4->setPlainText(QApplication::translate("changeIP", "106", 0));
        buttonOK->setText(QApplication::translate("changeIP", "OK", 0));
        buttonCancel->setText(QApplication::translate("changeIP", "Cancel", 0));
    } // retranslateUi
